...
::: {.column-float-left style="width: 45%; margin-right: 20px; margin-bottom: 10px;"}
![My workspace at the Strong Artificial Intelligence Lab (SAIL).](images/about-me.png){.about-image}
:::
